...
function PreTitleStory:new()
    ...
    self.lines = { 
		...
		,"Technology laid bare humanity’s insecurities, breaking the once common bonds of society. My robotics became tools that only seemed to exacerbate the insatiable hunger of man. "
