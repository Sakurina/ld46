...
function CityIntroStory:new()
    ...
    self.lines = { 
        ...
        "The Capital District housed the highest performers of society and it only made sense to take her there if I was to give her the best impression of humans.",
        ...
        "Looking around, I realize I had been so distracted by the GIVERs movements that we stumbled out of the Capital District and into the Auxiliary District.",
