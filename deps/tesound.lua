...
-- Patched by Sakurina to fix for LOVE 11.x
TEsound = {}        -- Namespace
...
function TEsound.play(sound, tags, volume, pitch, func)
  ...
  local streamtype = "static"
  if tags == 'music' then
    streamtype = 'stream'
  end
  table.insert(TEsound.channels, { love.audio.newSource(sound, streamtype), func, {volume or 1, pitch or 1}, tags=(type(tags) == "table" and tags or {tags}) })
